...
const Enter: NextPage = () => {
    const [enter, { loading, error, data }] = useMutations<MutationResult>("/api/users/enter");
    const [confirmToken, { loading: tokenLoading, error: tokenError, data: tokenData }] =
        useMutations<MutationResult>("/api/users/confirm");
